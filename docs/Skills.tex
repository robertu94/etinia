...
unit}{Take Energy from foe,Cast 2 heal actions in one turn (+2
difficulty)}{Revive from KO (difficulty 14),Cast 3 heal actions in one turn (+3
...
Attack,Defense,or Speed; buff removed when user cannot use Extension}{+1 
extensions}{+1 extensions; +1 hand for 3 extensions}{+1 extensions}{+1
...
drones controller unit is hit.}{Create Heal Drone (create 1 unit that
...
\skill{Fields}{field radius 1; buff 1 attack,defense,or speed.}{debuff 1
foe's attack,defense,or speed}{recurring buff (3,1,HP); negate
